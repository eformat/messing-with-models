...
#git clone https://github.com/eformat/blog.eformat.me
...
docs = SimpleDirectoryReader(
    "./blog.eformat.me", file_extractor=file_extractor
).load_data()
...
query_str="what is a vlan?"
output = dspy_qp(query_str=query_str)
print(f"Question: {query_str}")
print(output)

query_str="what is gitops?"
output = dspy_qp(query_str=query_str)
print(f"Question: {query_str}")
print(output)

query_str="what is policy as code?"
output = dspy_qp(query_str=query_str)
print(f"Question: {query_str}")
print(output)

query_str="can i use argocd and Advanced Cluster Manager together?"
output = dspy_qp(query_str=query_str)
print(f"Question: {query_str}")
print(output)

query_str="what is a linux vrf?"
output = dspy_qp(query_str=query_str)
print(f"Question: {query_str}")
print(output)
